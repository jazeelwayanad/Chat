  ...
  return (
    <div className="min-h-screen bg-[#111b21]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex gap-8">
        {/* Main Section - Joined & Public Groups */}
        <div className="flex-1 space-y-8">
          {/* Create Group Section */}
          <div className="bg-[#1a2b32] rounded-lg shadow-lg p-6">
          ...
          <div className="bg-[#1a2b32] rounded-lg shadow-lg">
            <div className="px-6 py-4 border-b border-gray-700">
              <h2 className="text-lg font-medium text-white">My Groups</h2>
            </div>
        ...
        {/* Right Section - Other Groups */}
        <div className="w-96">
          <div className="bg-[#1a2b32] rounded-lg shadow-lg sticky top-8">
            <div className="px-6 py-4 border-b border-gray-700">
              <h2 className="text-lg font-medium text-white">Available Groups</h2>
            </div>
            <ul className="divide-y divide-gray-700">
              {groups.filter(group => !group.isMember).map((group) => (
                <li key={group.id} className="p-6 hover:bg-[#233b44] transition-colors duration-150">
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[#58cc02] hover:bg-[#46a102]"
                    >
                      Join Group
                    </button>
                  </div>
